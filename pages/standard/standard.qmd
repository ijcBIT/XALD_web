...
**Model4** is a simplification model where we compare all controls against all cases without considering different disease phenotypes or age groups.
...
-   Control: Healthy samples both for pediatric and adult samples.

-   Disease: Samples with disease phenotype.
...
Bear in mind that the balance between AMN and cerebral condition is uneven, therefore the effect of XALD prevails.
